...
void ProductGUIModel::initializeGUIComponents() {
	...
	btnAddSong = new QPushButton("Adauga masina");
	...
	btnSortMeds = new QPushButton("Sorteaza masini");
	...
	btnFilterMeds = new QPushButton("Filtreaza masini dupa producator");
	...
	btnReteta = new QPushButton{ "Deschide spalatoria" };
...
void ProductGUIModel::guiAddSong() {
	try {
		...
		QMessageBox::warning(this, "Warning", "Date nevalide");
	}
