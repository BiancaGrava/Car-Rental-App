...
private:
	...
	QPushButton* butonSorteazaDenumire = new QPushButton{ "&Sorteaza dupa nr de inmatriculare" };
	QPushButton* butonSorteazaProducator = new QPushButton{ "&Sorteaza dupa producator" };
	QPushButton* butonSorteazaPretSubst = new QPushButton{ "&Sorteaza dupa tip si model" };

	QPushButton* butonReteta = new QPushButton{ "&CosCRUDGUI" };
	QPushButton* butonReadOnly = new QPushButton{ "&CosReadOnlyGUI" };
	QPushButton* butonAdaugaReteta = new QPushButton{ "&Adauga in spalatorie" };
	QPushButton* butonGolesteReteta = new QPushButton{ "&Goleste spalatoria" };
