...
public:
	...
	*/
	void addMed(const string& denumire, const string& producator, const string& pret, const string& substantaActiva);

	/* Valideaza campurile introduse si modifica medicamentul, daca exista */
	void modifyMed(const string& denumire, const string& producator, const string& pret, const string& substantaActiva, const int& camp);
	...
	vector<Medicament> filterMeds(const string& pret, const string& substantaActiva, const int& criteriu) const;
	...
	*/
	void addReteta(const string& denumire, const string& producator, const string& pret, const string& substantaActiva);
