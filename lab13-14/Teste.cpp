...
void Test::testGetMedicament()
{
	...
	assert(m.getInmatriculare() == "Nurofen");
	assert(m.getModel() == 25.5);
...
void Test::testModificare()
{
	...
	r.modify(pret2, 1);
	vector<Medicament> allMeds = r.getMeds();
	assert(allMeds[0].getModel() == 50);
	assert(allMeds[0].getTip() == 2);
	...
	r.modify(subst2, 2);
	allMeds = r.getMeds();
	assert(allMeds[1].getModel() == 23);
	assert(allMeds[1].getTip() == 2);

	// modificare ambele campuri
	r.modify(pret1, 3);
	allMeds = r.getMeds();
	assert(allMeds[0].getModel() == 34);
	assert(allMeds[0].getTip() == 2);
...
void Test::testSortari()
{
	...
	assert(rez[0].getInmatriculare() == "Nurofen");
	assert(rez[1].getInmatriculare() == "Panadol");

	// sortarea dupa producator
	rez = s.sortByProducator();
	assert(rez[0].getInmatriculare() == "Panadol");
	assert(rez[1].getInmatriculare() == "Nurofen");
	...
	rez = s.sortBySubstantaSiPret();
	assert(rez[0].getInmatriculare() == "ACC");
}
